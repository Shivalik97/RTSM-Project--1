...
messageData <- data.frame(
  from = c("Admininstrator", "Shivalik Singh"),
  message = c(
...
shinyServer(function(input, output){
  ...
  output$about<- renderInfoBox({
    infoBox(title = tags$b("World Happiness Index:"),
            subtitle = tags$b("The World Happiness Data is a survey conducted by the United Nations.
  ...
  output$source<- renderInfoBox({
    infoBox(title = tags$b("Data Source:"),
            subtitle = tags$b("These datasets were taken from the kaggle website.
